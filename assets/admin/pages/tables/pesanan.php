...
?>
  ...
  <div class="content-wrapper" style="background-color: #454d55;">
        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active" style="color: lightgrey;">Data Pesanan</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
    ...
    if (isset($_GET['id_pesanan'])) {
        ...
        $row = mysqli_fetch_array(mysqli_query($koneksi, "SELECT * FROM menu WHERE id_pesanan = '$id_pesanan' "));

        if ($id_pesanan != "") {
            $hapus = "DELETE FROM pesanan WHERE id_pesanan = '$id_pesanan' ";
...
<div class="card-body">
    <table id="example1" class="table table-bordered table-striped">
        ...
        <tbody>
            <?php
            $sql = "SELECT det_pesanan.id_pesanan, GROUP_CONCAT(menu.nama_menu SEPARATOR ', ') AS daftar_menu, pesanan.username, pesanan.tanggal_pemesanan, pesanan.status, pesanan.pembayaran, SUM(menu.harga) AS totalharga
            FROM det_pesanan
            INNER JOIN pesanan ON det_pesanan.id_pesanan = pesanan.id_pesanan
            INNER JOIN menu ON det_pesanan.id_menu = menu.id_menu
            GROUP BY det_pesanan.id_pesanan, pesanan.username, pesanan.tanggal_pemesanan, pesanan.status, pesanan.pembayaran
            ORDER BY det_pesanan.id_pesanan ASC";
