  ...
  <div class="content-wrapper" style="background-color: #454d55;">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 style="color: white;">Data Makanan</h1>
          </div>
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item active"><a href="index.php">Home</a></li>
              <li class="breadcrumb-item active" style="color: lightgrey;">Data Makanan</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
    ...
    if (isset($_GET['id_menu'])) {
        ...
        $row = mysqli_fetch_array(mysqli_query($koneksi, "SELECT * FROM menu WHERE id_menu = '$id_menu' "));
    ...
    <div class="card-body">
        <table id="example1" class="table table-bordered table-striped">
            ...
            <?php
              $No = 1;
              $sql = "SELECT * FROM menu WHERE id_menu LIKE 'MNU%' ORDER BY id_menu ASC";
              ...
              while ($row = mysqli_fetch_array($query)) {
                  ...
                  <tr>
                      ...
                      <td class='project-actions text-right'>
                          <a class='btn btn-info btn-sm' href='edit_menu.php?id_menu={$row['id_menu']}'>
                              <i class='fas fa-pencil-alt'></i> Edit
                          </a>
                          <a class='btn btn-danger btn-sm' href='delete_menu.php?id_menu={$row['id_menu']}'>
