...
<a href="<?php echo $indexPage; ?>" class="brand-link">
...
?>
  ...
  <div class="content-wrapper" style="background-color: #454d55;">
    ...
    if (isset($_GET['id_menu'])) {
        ...
        $row = mysqli_fetch_array(mysqli_query($koneksi, "SELECT * FROM menu_minuman WHERE id_menu = '$id_menu' "));

        if ($id_menu != "") {
            $hapus = "DELETE FROM menu_minuman WHERE id_menu = '$id_menu' ";
