...
if (isset($_POST['submit'])) {
    ...
    $sql = "INSERT INTO admin (username, password, nama, no_telp, email, alamat, status) VALUES ('$username', '$password', '$nama', '$no_telp', '$email', '$alamat', '$status')";
        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active" style="color: lightgrey;">Tambah Data Pegawai</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
          ...
          <div class="col-md-6" >
            ...
            <div class="card card-primary" style="width: 1070px;">
              <div class="card-header" style="background-color: #343a40;">
                <h3 class="card-title" style="color: white;">Tambah Data Pegawai</h3>
              </div>
              <!-- /.card-header -->
              <!-- form start -->
              <form name="addpegawai" method="post" action="<?php echo $_SERVER["PHP_SELF"]; ?>">
                ...
                <div class="form-group">
                    ...
                    <input name="no_telp" type="text" class="form-control" id="exampleInputEmail1" placeholder="Enter no telepon">
                </div>
                <div class="form-group">
